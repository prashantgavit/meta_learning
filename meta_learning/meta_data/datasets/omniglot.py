...
from meta_learning.meta_data.utils.data import Dataset, ClassDataset, CombinationMetaDataset
from torchvision.datasets.utils import list_dir, download_url
from meta_learning.meta_data.datasets.utils import get_asset
...
class OmniglotClassDataset(ClassDataset):
    ...
    def __getitem__(self, index):
        ...
        # print('index - ',index)
        # print("index % self.num_classes",index % self.num_classes)
